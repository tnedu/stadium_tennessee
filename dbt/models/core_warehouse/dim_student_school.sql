...
{{ edu_wh.cds_depends_on('edu:stu_demos:custom_data_sources') }}
...
formatted as (
    ...
    {{ edu_wh.add_cds_joins_v1(custom_data_sources=custom_data_sources, driving_alias='stu_demos', join_cols=['k_student']) }}

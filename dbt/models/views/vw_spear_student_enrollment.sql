...
with q as (
    ...
    sc.school_id, sc.school_name, s.student_unique_id, s.state_student_id, s.last_name, s.first_name,
    ssa.grade_level_integer, ssa.entry_date, ssa.exit_withdraw_date,
    row_number() over (

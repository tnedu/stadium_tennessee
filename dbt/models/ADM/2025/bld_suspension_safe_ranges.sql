...
clean_suspensions as (
    select k_student, k_school, k_school_calendar, school_year, tenant_code, discipline_action, discipline_date_begin, discipline_date_end,

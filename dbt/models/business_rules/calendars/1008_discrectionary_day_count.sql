...
xwalk_calendar_events as (
    ...
    where is_discretionary_day = true 
),
calendar_events as (
...
errors as (
    ...
    concat('Calendar ', c.calendar_code, ' has calculated total discretionary days more than the maximum of 4. Total days calculated: ',

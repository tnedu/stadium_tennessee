...
select sep.k_school, sep.k_school_calendar, sep.school_year, sep.school_id, sep.calendar_code, 
    ...
    concat('Calendar ', sep.calendar_code, ' has total calculated In-Service days less than the minimum of 5.0. Total days calculated: ',
...
where coalesce(sep.sum_event_values, 0) < 5
order by 3, 4, 5